...
// Added isGenerating and onGenerate props for internal dashboard usage
export default function DeathCertiAffidavit({ isGenerating, onGenerate }) {
      ...
      <div id="form-container" className="w-full bg-white p-4 md:p-6 shadow-xl rounded-xl h-auto border-t-[6px] border-blue-600 scroll-smooth print:hidden relative">
        ...
        <div className="w-full bg-white rounded-3xl shadow-sm px-3 py-4 border border-gray-200">
          <div className="grid grid-cols-2 gap-3">
            ...
            >
              {showWatermark} {/*&& <span className="absolute -top-2 right-2 text-[11px] bg-black text-white px-2 py-[2px] rounded-full shadow-lg">वॉलेट से ₹5</span>*/}
              <Printer size={20} />
