...
export default function DeathCertificateDeclaration() {
  ...
  const executeDownloadPDF = async () => {
    ...
    try {
      await new Promise((resolve) => setTimeout(resolve, 200)); // Wait for watermark to disappear
  ...
  try {
    ...
    const options = {
      ...
      description: "Premium Declaration Document (No Watermark)",
      ...
      handler: async function (response) {
        ...
        // डेटाबेस में सेल काउंट अपडेट करने वाला API कॉल
  ...
  return (
    <div className="p-2 md:p-6 max-w-[1400px] mx-auto bg-gray-100 flex flex-col lg:flex-row gap-6 font-sans">
      ...
      <div id="form-container" className="w-full lg:w-1/3 bg-white p-4 md:p-6 shadow-xl rounded-xl h-auto lg:h-[88vh] overflow-y-auto border-t-[6px] border-blue-600 scroll-smooth print:hidden relative">
        ...
        {/* --- STICKY BOTTOM BUTTONS (Premium Options) --- */}
